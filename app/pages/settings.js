...
import { Heading, Textarea, Button, VStack, HStack, Text } from '@chakra-ui/react'
  ...
  return (
    <Layout>
      ...
      <VStack align="stretch">
        <Textarea value={configText} onChange={(e)=>setConfigText(e.target.value)} minH="360px" fontFamily="monospace" />
